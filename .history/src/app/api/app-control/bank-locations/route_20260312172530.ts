...
export async function POST(req: Request) {
  try {
    ...
    const query = `INSERT INTO ${TABLE} ("PlaceName","Latitude","Longitude","Location","Description","Type","Status","Rank") VALUES (:name,:lat,:lng,:loc,:desc,:type,:status,:rank) RETURNING "Lid" INTO :lid`;
