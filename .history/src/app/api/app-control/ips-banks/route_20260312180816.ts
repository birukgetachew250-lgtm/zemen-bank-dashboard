...
export async function POST(req: Request) {
  try {
    ...
    await executeQuery(CS, `INSERT INTO ${TABLE} ("Id","BankName","BankCode","ReconciliationAccount","BankLogo","PrimaryColor","SecondaryColor","AccentColor","Status","Rank","CreatedAt","UpdatedAt") VALUES (:id,:name,:code,:recon,:logo,:pColor,:sColor,:aColor,:status,:rank,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP)`, {
...
export async function PUT(req: Request) {
  try {
    ...
    const map: Record<string, string> = { BankName:'name',BankCode:'code',ReconciliationAccount:'recon',BankLogo:'logo',PrimaryColor:'pColor',SecondaryColor:'sColor',AccentColor:'aColor',Status:'status',Rank:'rank' };
