      ...
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <Suspense fallback={<StatsCardSkeleton />}>
            <StatsCard title="Total App Users" value={stats.total} icon={<Users />} gradientStyle="hsl(347, 72%, 44%)" subtitle="All registered users" />
          </Suspense>
          <Suspense fallback={<StatsCardSkeleton />}>
            <StatsCard title="Linked Accounts" value={stats.linkedAccounts} icon={<Link />} gradientStyle="hsl(233, 55%, 52%)" subtitle="Active linked bank accounts" />
          </Suspense>
          <Suspense fallback={<StatsCardSkeleton />}>
            <StatsCard title="Active Users" value={stats.active} icon={<UserCheck />} gradientStyle="hsl(142, 71%, 45%)" subtitle="Currently active" />
          </Suspense>
          <Suspense fallback={<StatsCardSkeleton />}>
            <StatsCard title="Inactive / Dormant" value={stats.inactive} icon={<UserX />} gradientStyle="hsl(38, 92%, 50%)" subtitle="Inactive or dormant accounts" />
          </Suspense>
        </div>
      </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200/60 p-5 transition-all hover:-translate-y-0.5 hover:shadow-lg">
            ...
            <div className="flex items-start justify-between mb-3">
              <div>
                ...
                <p className="text-3xl font-extrabold text-amber-900 mt-1">—</p>
              </div>
            ...
            <a href="/overview/maker" className="inline-flex items-center gap-1 text-xs font-semibold text-amber-700 mt-3 hover:text-amber-900 transition-colors">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200/60 p-5 transition-all hover:-translate-y-0.5 hover:shadow-lg">
            ...
            <div className="flex items-start justify-between mb-3">
              <div>
                ...
                <p className="text-3xl font-extrabold text-blue-900 mt-1">—</p>
              </div>
            ...
            <a href="/overview/checker" className="inline-flex items-center gap-1 text-xs font-semibold text-blue-700 mt-3 hover:text-blue-900 transition-colors">
