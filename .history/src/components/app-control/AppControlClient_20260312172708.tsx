...
import { PlusCircle, Trash2, Loader2, Edit, Search, RefreshCw } from "lucide-react";
import Link from "next/link";

export default function AppControlClient() {
  const sections = [
    { title: "Bill Payments", items: [
      { label: "Bill Categories", href: "/app-control/bill-categories", desc: "Manage bill payment categories" },
      { label: "Bill Subcategories", href: "/app-control/bill-subcategories", desc: "Manage subcategories under bill categories" },
      { label: "Bill Providers", href: "/app-control/bill-providers", desc: "Manage bill payment providers" },
      { label: "Form Fields (SDUI)", href: "/app-control/bill-form-fields", desc: "Configure dynamic form fields for providers" },
      { label: "Flow Steps (SDUI)", href: "/app-control/bill-flow-steps", desc: "Configure payment flow steps" },
      { label: "API Configs", href: "/app-control/bill-api-configs", desc: "Provider API integration settings" },
      { label: "Display Fields", href: "/app-control/bill-display-fields", desc: "Confirmation & receipt screen fields" },
    ]},
