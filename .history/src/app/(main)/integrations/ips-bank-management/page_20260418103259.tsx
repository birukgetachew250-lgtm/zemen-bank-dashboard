...
async function getBanks(): Promise<IPSBank[]> {
  try {
    const query = `SELECT "Id", "BankName", "BankCode", "ReconciliationAccount", "BankLogo", "BranchCode", "Status", "Rank", "CreatedAt", "UpdatedAt" FROM "APP_CONTROL_MODULE"."IPSBank" ORDER BY "Rank" ASC`;
