...
export async function POST(req: Request) {
  ...
  try {
    ...
    if (!grpcResponse || !grpcResponse.success) {
      ...
      return { 
        status: 598, 
        message: response.message || "Operation not Working." 
      };
    }
    ...
    console.info('Decoded AccountDetailResponse 1:', object);
    ...
    return NextResponse.json({
      ...
      status: object.status || grpcResponse.status,
      serverMessage: object.message || grpcResponse.message,
