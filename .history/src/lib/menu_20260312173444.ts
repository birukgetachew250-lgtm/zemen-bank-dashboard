    ...
    children: [
      {
        ...
        icon: Receipt,
        children: [
          { icon: LayoutGrid, label: "Categories", href: "/app-control/bill-categories" },
          { icon: Layers, label: "Subcategories", href: "/app-control/bill-subcategories" },
          { icon: Building2, label: "Providers", href: "/app-control/bill-providers" },
          { icon: FormInput, label: "Form Fields", href: "/app-control/bill-form-fields" },
          { icon: GitBranch, label: "Flow Steps", href: "/app-control/bill-flow-steps" },
          { icon: Plug, label: "API Configs", href: "/app-control/bill-api-configs" },
          { icon: Columns, label: "Display Fields", href: "/app-control/bill-display-fields" },
        ],
      },
      {
        label: "Mini Apps",
