...
interface RecentErrorRow { SERVICE_NAME: string; ENDPOINT_URL: string; STATUS: string; ERROR_MESSAGE: string; CREATED_DATE: string; }
                ...
                <tbody>
                  {stats.recentErrors.map((e, i) => (
                    <tr key={i} className="border-b last:border-0 hover:bg-muted/40">
                      ...
                      <td className="py-2 pr-4 text-muted-foreground max-w-[240px] truncate">{e.ERROR_MESSAGE || '—'}</td>
