...
export async function POST(req: Request) {
  try {
    ...
    await executeQuery(CS, `INSERT INTO ${TABLE} ("Id","UniqueKey","IntegrationName","BaseUrl","Username","Password","ApiKey","AuthenticationParams","IntegrationType","TimeoutSeconds","MaxRetryAttempts","UseSSL","Status","IsProduction","CreatedBy","UpdatedBy") VALUES (:id,:ukey,:name,:url,:user,:pass,:apiKey,:authParams,:itype,:timeout,:maxRetry,:ssl,:status,:isProd,:createdBy,:updatedBy)`, {
