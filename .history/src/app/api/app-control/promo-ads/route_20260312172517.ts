...
export async function POST(req: Request) {
  try {
    ...
    await executeQuery(CS, `INSERT INTO ${TABLE} ("Id","Title","Subtitle","PageNumber","Description","TargetUrl","ImageUrl","ThumbnailUrl","DisplayOrder","AdType","StartDate","EndDate","Status","CreatedBy","UpdatedBy") VALUES (:id,:title,:subtitle,:page,:desc,:target,:image,:thumb,:order,:adType,:startDate,:endDate,:status,:createdBy,:updatedBy)`, {
      id, title: b.Title, subtitle: b.Subtitle || null, page: b.PageNumber, desc: b.Description || null,
