...
async function getCustomers(channel: 'mobile' | 'ussd') {
  ...
  try {
    ...
    const query = `SELECT * FROM "USER_MODULE"."AppUsers" WHERE "${statusCol}" = 'Active' ORDER BY "InsertDate" DESC`;
  ...
  return (
    <div className="w-full h-full flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold tracking-tight text-foreground">Active Customers Report</h1>
      </div>
