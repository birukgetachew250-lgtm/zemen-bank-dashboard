...
export async function POST(req: Request) {
    try {
        ...
        const query = `
            INSERT INTO ${TABLE}
                ("Id", "ChargeRuleId", "TierName", "AmountFrom", "AmountTo", "Percentage", "FixedAmount", "VatPercentage", "MinCharge", "MaxCharge", "DisplayOrder", "IsActive", "InsertDate", "UpdateDate")
            VALUES
                (:Id, :ChargeRuleId, :TierName, :AmountFrom, :AmountTo, :Percentage, :FixedAmount, :VatPercentage, :MinCharge, :MaxCharge, :DisplayOrder, 1, SYSTIMESTAMP, SYSTIMESTAMP)
        `;
        const binds = {
            Id: id,
            ChargeRuleId: chargeRuleId,
