...
export async function POST(req: Request) {
  try {
    ...
    await executeQuery(CS, `INSERT INTO ${TABLE} ("PolicyId","SectionCode","SectionHeader","SectionSummary","SectionContent","IconName","DisplayOrder","Version","EffectiveDate","LastUpdated","Status","CreatedBy","UpdatedBy") VALUES (:id,:code,:header,:summary,:content,:icon,:order,:ver,:effDate,:lastUpd,:status,:createdBy,:updatedBy)`, {
