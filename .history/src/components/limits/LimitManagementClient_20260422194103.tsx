...
export function LimitManagementClient({ initialLimitRules, customerCategories, transactionTypes, intervals }: LimitManagementClientProps) {
  ...
  const openAddDialog = () => {
    setEditingRule(null);
    setRuleData({ categoryId: "", transactionTypeId: "", serviceName: "", isGlobal: false, currency: "ETB", effectiveFrom: "", effectiveTo: "", perTransactionLimit: "", limits: [{ intervalId: "", amount: "" }] });
    setDialogOpen(true);
  };
