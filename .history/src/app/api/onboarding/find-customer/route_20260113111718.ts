...
export async function POST(req: Request) {
    ...
    try {
     ...
     console.info('Received gRPC response [CheckCustomer]', grpcResponse as unknown as Record<string, unknown>);
    ...
    const decoded = ViewBalanceResponseMessage.decode(buffer);
