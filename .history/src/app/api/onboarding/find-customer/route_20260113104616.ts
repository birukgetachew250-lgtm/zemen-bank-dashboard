...
let client: any;
let CustomerDetailMessage: any = null;
try {
    ...
    CustomerDetailMessage = grpcObj.accountdetail.CustomerDetail;
...
export async function POST(req: Request) {
    ...
    try {
        ...
        const decoded = CustomerDetailMessage.decode(buffer);
        const object = CustomerDetailMessage.toObject(decoded, {
                    longs: String,
                    enums: String,
                    defaults: true,
                    arrays: true,
        ...
        console.info('Decoded AccountDetailRequest', object);
        return NextResponse.json({
            success: grpcResponse.success,
            message: grpcResponse.message,
            code: grpcResponse.code,
            customer: buffer , // adjust based on real response
