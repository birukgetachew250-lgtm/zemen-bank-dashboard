...
export async function POST(req: Request) {
  try {
    ...
    await executeQuery(CS, `INSERT INTO ${TABLE} ("CategoryId","CategoryName","CategoryCode","Description","IconUrl","ColorHex","Status","Rank","CreatedBy","UpdatedBy") VALUES (:id,:name,:code,:desc,:icon,:color,:status,:rank,:createdBy,:updatedBy)`, {
