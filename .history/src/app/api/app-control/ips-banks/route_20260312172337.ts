...
export async function POST(req: Request) {
  try {
    ...
    await executeQuery(CS, `INSERT INTO ${TABLE} ("Id","BankName","BankCode","ReconciliationAccount","BankLogo","PrimaryColor","SecondaryColor","AccentColor","Status","Rank") VALUES (:id,:name,:code,:recon,:logo,:pColor,:sColor,:aColor,:status,:rank)`, {
