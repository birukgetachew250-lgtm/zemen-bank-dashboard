  ...
  if (_authSession instanceof NextResponse) return _authSession;
    try {
        ...
        const query = `
            ...
            VALUES (:Id, :CIFNumber, :AccountNumber, :AdditionalDailyLimit, :AdditionalWeeklyLimit, :AdditionalMonthlyLimit, :IsOverride, :Reason, CASE WHEN :EffectiveFrom IS NOT NULL THEN TO_TIMESTAMP(:EffectiveFrom, 'YYYY-MM-DD"T"HH24:MI') ELSE NULL END, CASE WHEN :EffectiveTo IS NOT NULL THEN TO_TIMESTAMP(:EffectiveTo, 'YYYY-MM-DD"T"HH24:MI') ELSE NULL END, 1, SYSTIMESTAMP, SUBSTR(RAWTOHEX(SYS_GUID()), 1, 8))
        `;
