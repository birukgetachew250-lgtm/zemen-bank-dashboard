...
export function ChargeTierManagementClient({
  ...
  const isFormOpen = editingTier !== null || tierData.amountFrom !== '' || tierData.tierName !== '';
          ...
          {isFormOpen && (
            <div className="grid gap-4 rounded-md border bg-muted/30 p-4">
              ...
              <div className="flex justify-end gap-2">
                <Button variant="outline" onClick={() => { setEditingTier(null); setTierData({ tierName: '', amountFrom: '', amountTo: '', percentage: '', fixedAmount: '', vatPercentage: '', minCharge: '', maxCharge: '', displayOrder: String(tiers.length + 1) }); }}>
                  Cancel
                </Button>
                {!editingTier && (
