...
let client: any;
let AccountDetailResponseProto: any ;
try {
...
export async function POST(req: Request) {
    ...
    try {
        ...
        const decoded = accountdetail.decode(buffer);

    const object = ViewBalanceResponseMessage.toObject(decoded, {
      longs: String,
      enums: String,
      defaults: true,
      arrays: true,
    ...
    logger.info('Decoded CheckBalanceUSSDResponse', object)
