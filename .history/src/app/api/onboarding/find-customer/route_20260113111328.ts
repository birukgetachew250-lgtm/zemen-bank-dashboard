...
try {
    ...
    AccountDetailResponseProto = root.lookupType('accountdetail.AccountDetailResponse');

    if (!AccountDetailResponseProto) {
        throw new Error("AccountDetailResponse type not found");
    }
    console.log('[PROTO] Successfully loaded with protobufjs');
    console.log('[PROTO] Found type:', AccountDetailResponseProto.fullName);
